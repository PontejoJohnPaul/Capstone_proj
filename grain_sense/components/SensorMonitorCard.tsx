  ...
  return (
    <View style={monitorStyles.card}>
      <View style={monitorStyles.headerRow}>
        <View style={{ flex: 1 }}>
          <Text style={monitorStyles.name} numberOfLines={1}>
            {sensor.sensor_name || sensor.sensor_code}
          </Text>
          <Text style={monitorStyles.code} numberOfLines={1}>
            {sensor.sensor_code} · {sensor.gpio_pin}
          </Text>
        </View>
      ...
      {isDht ? (
        <>
          <View style={monitorStyles.readingRow}>
            <Text style={monitorStyles.readingLabel}>Temp</Text>
      ...
      {isDht ? (
        ...
        >
          <Text style={[monitorStyles.actionBtnText, { color: sensor.enabled ? '#E65100' : GREEN_MID }]}>
            {sensor.enabled ? 'End Batch' : 'Start Batch'}
          </Text>
        </TouchableOpacity>
      )}
    </View>
